...
export default function HomeScreen() {
  ...
  return (
    <main className="screen">
      ...
      <div className="stack">
        <button type="button" className="card" onClick={() => nav('/roulette')}>
        ...
        <button type="button" className="card" onClick={() => nav('/nearby')}>
          <span className="card-emoji">📍</span>
          <div>
        ...
        <button type="button" className="card" onClick={() => nav('/vote')}>
          <span className="card-emoji">👥</span>
          <div>
